...
#unsuccessful algorithm, disregard
def quickfill(mat,des_row,des_col,des_box):
    cloneMat = mat.copy()
    for a in mat:
        for b in a:
            if b == 0:
                ...
                saveNum = 0
                print("des_row:", des_row)
                print("des_row[row]:", des_row[row])
                for i in des_row[row]:
                    for j in des_col[col]:
                        for k in des_box[box]:
                            if i == j and i == k:
                                saveNum = i
                cloneMat[row][col] = saveNum
                if saveNum != 0:
                    des_row[row].remove(saveNum)
                    des_col[col].remove(saveNum)
                    des_box[box].remove(saveNum)
    return cloneMat
...
#unsuccessful algorithm, disregard
def fillwithColCheck(mat,des_row,des_col,des_box):
    cloneMat = mat.copy()
    for a in mat:
        for b in a:
            if b == 0:
                ...
                uniqueVal = True
                if saveNum != 0:
                    uniqueVal = checkAllColumns(col, des_col, saveNum)
                if saveNum != 0 and uniqueVal == True:
                    cloneMat[row][col] = saveNum
                    des_row[row].remove(saveNum)
                    des_col[col].remove(saveNum)
                    des_box[box].remove(saveNum)
...
#unsuccessful algorithm, disregard
def spotfill(mat,des_row,des_col,des_box):
    spotsFilled = 0
    cloneMat = mat.copy()
    for a in mat:
        for b in a:
...
def backtrackWhile(mat, des_row, des_col, des_box):
    ...
    while i < 9:
        ...
        while j < 9:
            ...
            #----print("i:", i)
            #----print("j:",j)
            #----print("fixPrev:",fixPrev)
            #----printMatrix(cloneMat)
            #----print(des_row[i],des_col[j],des_box[boxNum])
            #----print(attempted)
...
testingEasyPuzzles = ["090802750 000003164 300000009 014000000 200000300 530100000 000010020 980040000 020050007",
                  "030020040 060000900 000000050 890003000 106048003 000001480 301007600 009000000 000010524",
                  "000000200 710900580 009200460 008607040 004050010 001400002 020000097 900000800 000806000",
                  "734100000 090207350 100009000 000403010 000095002 000800004 402080600 000700040 650000000",
                  "703020050 040090001 000000004 000602000 001005000 000400102 000907030 302058060 008060017",
                  "103060000 500702900 080000240 390500060 060000054 000400300 000079580 000050400 070000032",
                  "000360000 036070050 008005009 080000340 007500000 042097000 000040090 700001203 195080000",
                  "000340000 006008054 050690020 003700000 000206008 100000000 890000017 600509000 024030000",
                  "020100035 090570040 004090060 100080009 000000000 036000000 200000000 380209001 009306070",
                  "000706023 600001500 000050407 000002006 020607001 080900050 400100900 050029000 000000300"]

testingMedPuzzles = ["080060000 003800579 000500000 209000030 000600010 000047600 018070000 000400800 000000026",
                     "002000040 130000000 000020007 800100000 200000059 000009004 004001090 320000000 700504003",
                     "090010020 560020000 000300000 003900000 000400567 200000013 008600001 000000032 000000450",
                     "060090000 100300008 300002000 000080010 004005080 630070500 050030060 000000007 900050403",
                     "001000090 000009000 020003057 000960000 003082000 004007008 970000000 060000800 000500160",
                     "000602004 908000002 000000300 000900070 005000010 000324000 100000020 650070000 040008700",
                     "080000094 005207006 300000000 193000400 000005800 060030000 024000003 000061080 000000000",
                     "300000650 400320000 000008900 006005100 008000000 000274000 000100003 050007000 000902006",
                     "000060000 805700060 020001700 042000000 010800000 000050040 009010000 004000806 000903050",
                     "000000084 050009001 800005000 307000000 060800000 008000042 021000005 403000020 000090600"]

testingHardPuzzles = ["000050810 040000000 080000000 000070000 100300070 920408300 000000100 208000904 070609000",
                      "790000200 080002004 060490000 000600000 020000041 000005002 005000008 900000010 400300090",
                      "125400000 000008040 000000100 000005360 200000000 000073800 080307009 004000000 059000018",
                      "005060049 000023000 080007000 050800002 700000030 090004000 900000650 000000004 040590300",
                      "000008000 000040057 003006040 602000000 400500030 070010005 001080060 000000809 700000400",
                      "600700009 008040000 500000026 000007530 002100090 900000040 000908000 007350000 001000080",
                      "008902000 041076000 200004730 002090603 000007400 000580000 000720010 010008200 000000567",
                      "700085000 000001004 000300200 800017000 000000409 000060080 020000093 080009001 000400002",
                      "200000000 000030400 000010793 700006030 003000670 510008000 000007500 000003061 460500000",
                      "810000004 000040008 004005700 180900000 009070000 000000100 000090200 090700060 000803501"]

testingAllPuzzles = ["090802750 000003164 300000009 014000000 200000300 530100000 000010020 980040000 020050007",
"030020040 060000900 000000050 890003000 106048003 000001480 301007600 009000000 000010524",
"000000200 710900580 009200460 008607040 004050010 001400002 020000097 900000800 000806000",
"734100000 090207350 100009000 000403010 000095002 000800004 402080600 000700040 650000000",
"703020050 040090001 000000004 000602000 001005000 000400102 000907030 302058060 008060017",
...
"020100035 090570040 004090060 100080009 000000000 036000000 200000000 380209001 009306070",
"000706023 600001500 000050407 000002006 020607001 080900050 400100900 050029000 000000300",
"080060000 003800579 000500000 209000030 000600010 000047600 018070000 000400800 000000026",
"002000040 130000000 000020007 800100000 200000059 000009004 004001090 320000000 700504003",
"090010020 560020000 000300000 003900000 000400567 200000013 008600001 000000032 000000450",
"060090000 100300008 300002000 000080010 004005080 630070500 050030060 000000007 900050403",
"001000090 000009000 020003057 000960000 003082000 004007008 970000000 060000800 000500160",
...
"000060000 805700060 020001700 042000000 010800000 000050040 009010000 004000806 000903050",
"000000084 050009001 800005000 307000000 060800000 008000042 021000005 403000020 000090600",
"000050810 040000000 080000000 000070000 100300070 920408300 000000100 208000904 070609000",
"790000200 080002004 060490000 000600000 020000041 000005002 005000008 900000010 400300090",
"125400000 000008040 000000100 000005360 200000000 000073800 080307009 004000000 059000018",
"005060049 000023000 080007000 050800002 700000030 090004000 900000650 000000004 040590300",
"000008000 000040057 003006040 602000000 400500030 070010005 001080060 000000809 700000400",
...
testing17Puzzles = ["000700000 100000000 000430200 000000006 000509000 000000418 000081000 002000050 040000300",
...
for a in testingHardPuzzles:
    ...
    for b in puzzle:
        ...
        for c in b:
            toInts.append(int(c))
        puzMat.append(toInts)
    des_b_row = []
    des_b_col = []
    des_b_box = []
    for b in puzMat:
        des_b_row.append(getMissingRowCol(b))
    for i in range(0,9):
        des_b_col.append(getMissingRowCol(getColumn(puzMat,i)))
    des_b_box = setDesiredBox(puzMat)
    tracemalloc.start()
    start = time.time()
    puzSol = backtrackWhile(puzMat, des_b_row, des_b_col, des_b_box)
    end = time.time()
    current,peak = tracemalloc.get_traced_memory()
    tracemalloc.stop()
    testMems.append(peak)
    ...
    j += 1
print("Times:",testTimes)
print("Memory:",testMems)
#print("Average 17 time:", ((testTimes[0] + testTimes[1] +testTimes[2])/3))
#print("Average 17 memory:",((testMems[0]+testMems[1]+testMems[2])/3))
